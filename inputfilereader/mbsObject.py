...
class rigidBody(mbsObject):
    def __init__(self, text):
        parameter = {       #Dictionary damit wir wisssen wonach wir suchen
            #vor doppelpunkt ... Key | nach Doppelpunkt ... Value
            "mass": {"type": "float", "value": 1.},    
            "COG": {"type": "vector", "value": [0.,0.,0.]}
        }
        
        mbsObject.__init__(self, "Body", "Rigid_EulerParameter_PAI", text, parameter)   #PAI ... Principle Axis Inertia